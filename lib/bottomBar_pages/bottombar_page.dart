...
class _BottomBarPageState extends State<BottomBarPage> {
  ...
  final List<BottomNavigationBarItem> bottomTabs = [
    ...
    BottomNavigationBarItem(
      ...
      activeIcon: Image.asset('images/activehome.png',),
//      icon: Image.network('https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=2907227418,1639643895&fm=26&gp=0.jpg'),
    ...
    BottomNavigationBarItem(
      ...
      activeIcon: Container(
        child: Image.asset('images/activesort.png',),
      ),
      title: Text('分类'),
    ),
    //非遗说
    BottomNavigationBarItem(
      ...
      activeIcon: Image.asset('images/activefind.png',),
      title: Text('非遗说'),
    ),
    //商城
    BottomNavigationBarItem(
      icon: Image.asset('images/shop.png'),
      activeIcon: Image.asset('images/activeshop.png',),
      title: Text('商城'),
    ),
    //我的
    BottomNavigationBarItem(
      icon: Image.asset('images/me.png'),
      activeIcon: Image.asset('images/activeme.png',),
      title: Text('我的'),
    ),
  ];
